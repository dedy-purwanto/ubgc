...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('entries_entry', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=True, related_name='entries', to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Entry.user'
        db.delete_column('entries_entry', 'user_id')
