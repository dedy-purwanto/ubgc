...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('entries_entry', 'disabled', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Entry.disabled'
        db.delete_column('entries_entry', 'disabled')
